...
export default function SpendForm() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-sm border border-zinc-200">
      <h2 className="text-2xl font-bold text-zinc-900 mb-6">AI Spend Audit</h2>
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <h3 className="text-lg font-semibold text-zinc-900">Subscriptions</h3>
          <button
        ...
        {auditData.subscriptions.length === 0 ? (
          <div className="text-center py-8 border-2 border-dashed border-zinc-200 rounded-xl text-zinc-500">
          ...
          <div className="space-y-4">
            {auditData.subscriptions.map((sub) => (
              <div
                key={sub.id}
                className="p-4 border border-zinc-200 rounded-xl bg-zinc-50 space-y-4"
              >
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-zinc-300 rounded-md bg-white text-sm"
                    >
                      {TOOLS.map((t) => (
      ...
      <div className="mt-8 pt-6 border-t border-zinc-200 flex justify-between items-center">
        <div>
          <p className="text-sm text-zinc-500">Total Monthly Spend</p>
        ...
        <button
          ...
          onClick={() => alert('Audit Engine not yet implemented!')}
        >
          Run Audit
        </button>
      </div>
